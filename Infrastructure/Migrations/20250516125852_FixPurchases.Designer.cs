...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250516125852_FixPurchases")]
    partial class FixPurchases
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.GroupTraining", b =>
                {
                    ...
                    b.Property<int>("RegistrationsRemaining")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.TrainerComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.UserMembership", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Purchase", "Purchase")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.UserMembership", "PurchaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
